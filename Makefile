...
all: SPH_2D SPH_2D_Euler

SPH_2D: $(BIN_DIR)/SPH_2D
SPH_2D_Euler: $(BIN_DIR)/SPH_2D_Euler

$(BIN_DIR)/SPH_2D: $(BUILD_DIR)/SPH_2D.o $(BUILD_DIR)/SPH_Snippet.o $(BUILD_DIR)/file_writer.o
	$(CXX) -o $@ $^

$(BIN_DIR)/SPH_2D_Euler: $(BUILD_DIR)/SPH_2D.o $(BUILD_DIR)/SPH_Snippet_Euler.o $(BUILD_DIR)/file_writer.o
	$(CXX) -o $@ $^
...
TESTS = test_SPH_2D test_SPH_2D_Euler test_file_writer
...
test_SPH_2D_Euler: $(TEST_BIN_DIR)/test_SPH_2D_Euler
...
$(TEST_BIN_DIR)/test_SPH_2D_Euler: $(TEST_BUILD_DIR)/test_SPH_2D_Euler.o $(BUILD_DIR)/SPH_2D.o
	$(CXX) -o $@ $^ $(CXXFLAGS) $(CPPFLAGS) $(LDFLAGS)
